...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --output-file "${staining_root}/A051_2080_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --output-file "${staining_root}/B051_6535_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --output-file "${staining_root}/C051_5050_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --specific-proportions 0.50 0.50 \
    --output-file "${staining_root}/C053_5050_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --specific-proportions 0.2 0.8 \
    --output-file "${staining_root}/B053_2080_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --specific-proportions 0.65 0.35 \
    --output-file "${staining_root}/A053_6535_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --specific-proportions 0.65 0.35 \
    --output-file "${staining_root}/A31_6535_bimix.fcs" \
    --enable-mixing & 
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --specific-proportions 0.50 0.50 \
    --output-file "${staining_root}/C31_5050_bimix.fcs" \
    --enable-mixing &  
...
python time_gate_executables/concatenate_fcs_cli.py \
    ...
    --output-file "${staining_root}/B31_8020_bimix.fcs" \
    --enable-mixing & 
