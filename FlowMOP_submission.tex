...
\textless{} 0.001). In the Bimix method, for the 5000-bin size, FlowMOP
demonstrated significantly higher removed-non-target purity than FlowCut
(p = 0.02). In the Trimix method, for the 5000-bin samples, FlowMOP also
had higher removed-non-target purity than FlowCut (p = 0.003). These
...
smaller bin-sized samples. FlowMOP had higher removed-non-target purity
than FlowCut for the large-bin Bimix and Trimix samples.
