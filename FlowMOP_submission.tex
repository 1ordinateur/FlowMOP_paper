...
not differ between groupwise and individual-sample debris gating, and
differed for doublet gating for only one expert. This indicates that the
overall comparison between FlowMOP and expert gating was not primarily
determined by the choice of groupwise or individual-sample gates.
