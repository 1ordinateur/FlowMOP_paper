...
The size of the simulated microblockage is determined by the ‘bin size’, where the larger bin sizes emulate larger blockages. As expected, retained-target and removed-non-target purity were reduced in the smaller bin-sized samples. FlowMOP had higher removed-non-target purity than FlowCut for the large-bin Bimix and Trimix samples.
