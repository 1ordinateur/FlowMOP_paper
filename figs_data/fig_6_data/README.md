...
CD3-CD19+ Q3 population, and the source counts use the original event count as
...
annotated. Panel C displays Live CD45+ cell-count recovery and B- and T-cell
population recovery relative to Raw.
