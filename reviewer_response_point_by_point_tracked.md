...
<span style="color:#c00000"><s>These biological analyses complement, but do</s></span><span style="color:#0066cc">In the tumour samples, Manual and FlowMOP preprocessing did</span> not <span style="color:#c00000"><s>convert,</s></span><span style="color:#0066cc">substantively differ across</span> the <span style="color:#c00000"><s>earlier forced expert rankings into an objective benchmark. The expert-ranking exercise remains an exploratory comparison of relative preferences</s></span><span style="color:#0066cc">measured populations (Figure 7). Together with the synthetic</span> and <span style="color:#c00000"><s>is addressed separately in Combined Comment 6.</s></span><span style="color:#0066cc">human PBMC findings, this suggests that FlowMOP performs comparably to manual preprocessing when the effects on relevant biological populations are considered.</span>
...
- We added <span style="color:#c00000"><s>a</s></span><span style="color:#0066cc">an eight-sample</span> PBMC <span style="color:#c00000"><s>biological-validation section based on prespecified downstream population endpoints; the final analysis</s></span><span style="color:#0066cc">biological validation with matched-Raw frequencies and counts for Live CD45+, B, T,</span> and <span style="color:#0066cc">NKT cells.</span> Figure 5 <span style="color:#c00000"><s>content remain a PLACEHOLDER.</s></span><span style="color:#0066cc">reports time-cleaning representatives (A), frequencies (B), and counts (C). Figure 6 reports the combined Time + Debris + Doublet representative (A) and the debris-only, doublet-only, and combined frequency (B) and count (C) comparisons. Supplementary Figure S8 contains the debris and doublet representative gates only.</span>
...
- We added a tumour validation comprising three tumour samples, with paired Raw, Manual, and FlowMOP comparisons of<span style="color:#c00000"><s>the T:B-cell ratio,</s></span> Live CD45+ cell count, B-cell frequency, and T-cell frequency. Figure <span style="color:#c00000"><s>6</s></span><span style="color:#0066cc">7</span> displays the matched gating plots and <span style="color:#c00000"><s>the Live CD45+ cell-count, B-cell-frequency, and T-cell-frequency</s></span><span style="color:#0066cc">downstream</span> comparisons.
...
**Location:** <span style="color:#0066cc">Results, “Expert preference evaluation”; Discussion; Conclusion;</span> Supplementary Information, “Supplementary expert preference evaluation,” including “Supplementary methods” and “Supplementary results”; Supplementary Figures <span style="color:#c00000"><s>S5–S7.</s></span><span style="color:#0066cc">S5–S7; Supplementary Tables S1B-E.</span>
...
**Location:** <span style="color:#0066cc">Methods, “Preparation of Human PBMC Samples for Synthetic Time Benchmarking Samples”;</span> Discussion, “Other <span style="color:#c00000"><s>remarks”; acquisition voltage/gain information: PLACEHOLDER.</s></span><span style="color:#0066cc">remarks.”</span>
